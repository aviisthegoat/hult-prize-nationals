...
import { HomePhotoFeatureRow, HomePhotoStrip } from "@/components/HomePhotoAccents";
...
export default function HomePage() {
  ...
  const homeStripPhotos = pickAccentUrls(galleryUrls, 5, 3);
  const homeFeaturePhotos = pickAccentUrls(galleryUrls, 3, 28);
  ...
  return (
    <>
      ...
      <HomePhotoStrip urls={homeStripPhotos} />
      ...
      <HomePhotoFeatureRow urls={homeFeaturePhotos} />
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
          {[
            ...
            },
            {
              title: "Gallery",
              href: "/photos",
              desc: "Photos from the Hult Prize community and past events.",
              color: "sky",
              icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
